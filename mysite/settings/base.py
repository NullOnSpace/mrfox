...
SECRET_KEY = os.environ.get('SECRET_KEY', 'hez=f0&69k!#n&do=_v(h$-td=l#fghqn-@**5hx=b74)wk_bh')
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            # When this changes, the redis config in ChatConfig also needs to.
